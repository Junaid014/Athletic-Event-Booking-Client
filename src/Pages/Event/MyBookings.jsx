    ...
    return (
        ...
        <>
         <div className='min-h-screen flex flex-col'>
            <h1 className=" text-4xl roboto mt-8 font-semibold text-gray-800 text-center">Events You've Booked</h1>

            <div className="flex justify-center mt-3 gap-4 ">
  <button
    className={`btn btn-sm ${viewType === 'table' ? 'btn-primary' : 'btn-outline'}`}
    onClick={() => setViewType('table')}
  >
    Table View
  </button>
  <button
    className={`btn btn-sm ${viewType === 'card' ? 'btn-primary' : 'btn-outline'}`}
...
{viewType === 'table' ? (
  // Table View (your original table)
