                ...
                <div className='pt-14 lg:flex  lg:justify-between border-b pb-14 border-[#F5F5F5]'>
                    ...
                    <div>
                        ...
                        <div className='flex gap-3 mt-4'>
                            <input type="text" placeholder="Email" className="input py-6" />
                            <button className='btn bg-gradient-to-r from-green-600 to-green-800 text-white rounded-lg shadow-md hover:from-green-700 hover:to-green-900 transition  duration-300 font-semibold px-6 py-6'>Subscribe</button>
                        </div>
                    </div>
                </div>
